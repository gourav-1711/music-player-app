...
export default function ExpandableCardDemo() {
  ...
  return (
    <>
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    className="px-4 py-3 text-sm rounded-full font-bold cursor-pointer bg-green-500 text-white">
                    Play Again
                  </motion.a>
                </div>
      ...
      <ul
        className=" mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start gap-4">
